...
class registro1_desk extends StatelessWidget {
  final VoidCallback onFormularioCompleto;
  registro1_desk({required this.onFormularioCompleto});
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: regis1(onFormularioCompleto),
    );
  }
}
...
class regis1 extends StatefulWidget {
  final VoidCallback onFormularioCompleto;
  regis1(this.onFormularioCompleto);

  @override
  State<regis1> createState() => _regis1State(onFormularioCompleto);

}

class _regis1State extends State<regis1> {
  final VoidCallback onFormularioCompleto;
  _regis1State(this.onFormularioCompleto);
  ...
  void _formularioCompleto() {

    if (onFormularioCompleto != null) {
                              ...
                              margin: EdgeInsets.only(top: 30),
                                child: TextButton(
                                  onPressed: () async {
                                      ...
                                      addRegistroHembra(id, nombre, fechaIngreso, fechaNacimiento, peso,pesones,camadas, context);
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.numbers,color: Color.fromRGBO(229, 203, 206, 1),size: 6 * fem),
          hintText: 'Ingrese Id',
          hintStyle: TextStyle(
            fontSize: 3 * fem,
            color: Colors.grey,
