...
class salud_tablet extends StatelessWidget {
  const salud_tablet({super.key});
...
class saludapp_ta extends StatefulWidget {
  @override
  State<saludapp_ta> createState() => _saludappState();
}

class _saludappState extends State<saludapp_ta> {
          ...
          Column(
            ...
            children:  [
              Container(
                ...
                height: 40 * fem,
                child: Container(
                  margin:  EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 0.72*fem),
               //   color: Colors.teal,
                  width:  40.7*fem,
                  height:  40.28*fem,
                  child:InkWell(
              ...
              Container(
                margin:  EdgeInsets.fromLTRB(27*fem, 0*fem, 26*fem, 23*fem),
          ...
          Container(
            child: TableCalendar(
              ...
              headerStyle: HeaderStyle(
                ...
                titleCentered: true,
                titleTextStyle: TextStyle(fontSize: 11 * fem),
              ),
              daysOfWeekStyle: DaysOfWeekStyle(
                weekdayStyle: TextStyle(fontSize: 7 * fem),
                weekendStyle: TextStyle(fontSize: 6 * fem),
              ),
              ...
              calendarStyle: CalendarStyle(
                defaultTextStyle: TextStyle(fontSize: 9 * fem),
