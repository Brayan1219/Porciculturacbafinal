...
class regis_crias_tablet extends StatelessWidget {
  final int idhembra;
  regis_crias_tablet(this.idhembra);

  @override
  Widget build(BuildContext context) {
    return crias_desk(idhembra);
  }
}

class crias_desk extends StatefulWidget {
  final int idhembra;
  crias_desk(this.idhembra);
  @override
  State<crias_desk> createState() => _crias_deskState(idhembra);
}

class _crias_deskState extends State<crias_desk> {
  final int idhembra;
  _crias_deskState(this.idhembra);
